...
class StudentsComponent extends Component
{
    ...
    protected $listeners = ['deleteStudentData'];
    ...
    public function editStudentData()
    {
        ...
        if($student){
            ...
            $this->dispatchBrowserEvent('edit-error', [
                'type'=>'error',
                'message' => 'Edit error',
                'position'=>'top-right'
            ]);
    ...
    public function render()
    {
        ...
        $students_res = Students::onlyTrashed()->count();
        return view('livewire.students-component', ['students'=>$students,'students_res'=> $students_res])->layout('livewire.layouts.base');
    }
}
